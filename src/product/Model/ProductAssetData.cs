...
namespace product.Model
{
    ...
    /// ProductAssetData
    /// </summary>
    [DataContract(Name = "productAssetData")]
    public partial class ProductAssetData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductAssetData" /> class.
        /// </summary>
        /// <param name="assetGrn">assetGrn.</param>
        /// <param name="localizedAssetGrn">localizedAssetGrn.</param>
        /// <param name="position">position.</param>
        /// <param name="metadata">metadata.</param>
        public ProductAssetData(string assetGrn = default(string), ProductLocalizedAsset localizedAssetGrn = default(ProductLocalizedAsset), long position = default(long), List<ProductAssetsEntryMetadata> metadata = default(List<ProductAssetsEntryMetadata>))
        {
