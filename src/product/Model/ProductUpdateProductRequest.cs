...
namespace product.Model
{
    ...
    /// </summary>
    [DataContract(Name = "productUpdateProductRequest")]
    public partial class ProductUpdateProductRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductUpdateProductRequest" /> class.
        /// </summary>
        ...
        public ProductUpdateProductRequest(string tenantId = default(string), string id = default(string), string code = default(string), ProductFieldMask attributesMask = default(ProductFieldMask), ProductLocalizedText urlKey = default(ProductLocalizedText), long maxSaleableQuantity = default(long), List<string> mediaVariantAttributes = default(List<string>), Dictionary<string, ProtobufAny> attributes = default(Dictionary<string, ProtobufAny>), Dictionary<string, ProductProductVariant> variants = default(Dictionary<string, ProductProductVariant>), bool inReview = default(bool))
        {
